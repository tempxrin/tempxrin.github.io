...
\section{Experiência Profissional}
    ...
    \cventry{Amazon Agrolog}{Londrina, PR}{Analytics Engineer}{Mai 2026 - Presente}
        \begin{itemize}
            ...
            \item Desenvolvimento de sistemas web com Flutter e Dart para atender demandas de todos os setores da empresa (operacional, administrativo, RH, comercial, transportes).
            \item Criação de dashboards e relatórios interativos no Power BI conectados ao data warehouse corporativo para suporte à tomada de decisão.
